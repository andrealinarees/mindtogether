package es.udc.asi.user.model.service;
...
import es.udc.asi.user.model.service.dto.NoteDTO;
import es.udc.asi.user.client.NoteServiceClient;
import es.udc.asi.user.model.domain.User;
import es.udc.asi.user.model.domain.UserAuthority;
import es.udc.asi.user.model.exception.NotFoundException;
import es.udc.asi.user.model.exception.OperationNotAllowed;
import es.udc.asi.user.model.exception.UserLoginExistsException;
import es.udc.asi.user.model.repository.UserDao;
import es.udc.asi.user.model.service.dto.UserDTOPrivate;
import es.udc.asi.user.model.service.dto.UserDTOPublic;
import es.udc.asi.user.model.service.dto.UserWithNotesDTO;
import es.udc.asi.user.security.SecurityUtils;
